...
static maxon::Id g_usedFrameworks[] = {maxon::Id("net.maxon.c4d.cinema.framework"), maxon::Id("net.maxon.core.framework"), maxon::Id("net.maxon.geom.framework"), maxon::Id("net.maxon.mesh_misc.framework"), maxon::Id("net.maxon.network.framework")};
